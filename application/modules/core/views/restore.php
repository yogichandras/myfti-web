...
$(document).on("click","#delete",function(e){
  ...
  $('#modalContent').html(`<p class="mb-4"><?=cclang("delete_description")?></p>
	                          ...
	                          <a type='button' class='btn btn-success btn-sm' id='ya-hapus' href=`+$(this).attr('href')+`><?=cclang("delete_action")?></a>
														`);
  $("#modalGue").modal('show');
});
...
$(document).on("click","#restore",function(e){
  ...
  $('#modalContent').html(`<p class="mb-4">Are you sure you want to restore database?</p>
														<button type='button' class='btn btn-default btn-sm' data-dismiss='modal'><?=cclang("cancel")?></button>
	                          <a type='button' class='btn btn-success btn-sm' id='ya-hapus' data-href=`+$(this).attr('href')+`><?=cclang("delete_action")?></a>
														`);
  $("#modalGue").modal('show');
});
