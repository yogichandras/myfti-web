    ...
    <div class="card m-b-30">
      ...
      <div class="card-body">
              ...
              <label>Icon</label>
                ...
                <div class="input-group col-xs-12">
                  ...
                  <span class="input-group-append">
                    <button class="file-upload-browse btn btn-success btn-sm" href="<?=url("core/icon")?>" id="icons" type="button">Icon</button>
            ...
            <div class="col-sm-12 mt-3">
              ...
              <button type="submit" id="submit" name="submit" class="btn btn-sm btn-success"><?=cclang("save")?></button>
            </div>
          </div>
        </form>
