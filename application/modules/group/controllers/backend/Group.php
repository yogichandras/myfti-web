...
/* dev : papicoding*/
/* fb : https://facebook.com/papicoding*/
/* fanspage : https://web.facebook.com/papicoding*/
/* web : www.papicoding.com*/
      ...
      foreach ($list as $rows) {
          ...
          $row[] = '
                    <div class="btn-group" role="group" aria-label="Basic example">
                        <a href="'.url("group/access_control/".enc_url($rows->id)).'" id="detail" class="btn btn-success" title="'.cclang("access_control").'">
