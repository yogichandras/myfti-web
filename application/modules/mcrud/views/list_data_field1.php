...
public function __construct()
{
  ...
  if (file_exists(APPPATH.'config/app.php')) {
    if (file_exists(APPPATH.'config/app.cfg')) {
      ...
      $arr2 	= array("app" => "m-code", "author" =>  "papicoding", "version" => "V.0.0.1", "facebook" => "https://web.facebook.com/papicoding", "fanspage" => "https://web.facebook.com/papicoding", "youtube" => "https://www.youtube.com/channel/UC1TlTaxRNdwrCqjBJ5zh6TA", "instagram"=>"https://www.instagram.com/programmer_jalanan");
