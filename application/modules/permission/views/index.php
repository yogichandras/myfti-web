          ...
          <div class="form-group col-sm-4 float-right">
            <div class="input-group">
              ...
              <div class="input-group-append">
                <button class="btn btn-sm btn-success btn-icon-text" id="filter" style="height:35px!important" type="button"><i class="fa fa-search"></i></button>
              </div>
            </div>
          </div>
        </div>
...
$(document).on("click","#delete",function(e){
  ...
  $('#modalContent').html(`<p class="mb-4"><?=cclang("delete_description")?></p>
	                          ...
	                          <button type='button' class='btn btn-success btn-sm' id='ya-hapus' data-id=`+$(this).attr('alt')+`  data-url=`+$(this).attr('href')+`><?=cclang("delete_action")?></button>
														`);
  $("#modalGue").modal('show');
});
...
$(document).on("click","#delete_select",function(e){
  ...
  $('#modalContent').html(`<p class="mb-4"><?=cclang("delete_description")?></p>
														<button type='button' class='btn btn-default btn-sm' data-dismiss='modal'><?=cclang("cancel")?></button>
	                          <button type='button' class='btn btn-success btn-sm' id='ya-hapus-select'  data-url=`+$(this).attr('href')+`><?=cclang("delete_action")?></button>
														`);
  $("#modalGue").modal('show');
});
