...
// 				$str.='<a href="'.$uri.'" id="filter-show" class="btn btn-sm btn-success btn-icon-text"><i class="mdi mdi-magnify btn-icon-prepend"></i> Filter</a>';
// 			}elseif ($button == 'detail') {
// 				$str.='<a href="'.$uri.'" id="detail" class="btn btn-success" title="'.cclang("detail").'"><i class="mdi mdi-file"></i></a>';
